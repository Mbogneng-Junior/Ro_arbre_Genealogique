...
import { User, Users, TreePalm, Search, Settings, Database } from 'lucide-react';
          ...
          <div className="bg-white rounded-xl shadow-lg p-6 border border-gray-100">
            {activeSection === 'gerer' && (
                <AddPersonForm
                    ...
                    onAddRelationship={handleAddRelationship} onRemovePerson={function (): void {
                  throw new Error('Function not implemented.');
                }} onRemoveRelationship={function (): void {
                  throw new Error('Function not implemented.');
                }}                />
            )}
